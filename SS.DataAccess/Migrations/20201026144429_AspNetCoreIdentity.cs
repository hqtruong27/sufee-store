    ...
    public partial class AspNetCoreIdentity : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.AlterColumn<DateTime>(
                ...
                oldType: "datetime2",
                oldDefaultValue: new DateTime(2020, 10, 26, 16, 26, 20, 62, DateTimeKind.Local).AddTicks(79));
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserLogins", x => new { x.ProviderKey, x.LoginProvider });
                    table.ForeignKey(
